<?php
ob_start();
$API_KEY = '1854265634:AAGxmBErC-53aGye5lqi_FdFnoAQkVIKw58'; //add your bot token
$bot_ = "The_security_of_his_country_bot";
 ...
 'parse_mode'=>'html',
   'reply_markup'=>json_encode([
     ...
     ['text'=>"اضفني الى مجموعتك ♣️", 'url'=>"https://telegram.me/$bot_?startgroup=start"]
    	...
    	[
     ['text'=>"مراسلة المطور 🚶", 'url'=>"t.me/ARLOUefg"]
     ],
	   [
...
sendaction($chat_id, typing);
   ...
   'reply_markup'=>json_encode([
      'inline_keyboard'=>[
	  [
	  ['text'=>"الصور",'url'=>"http://telegram.me/cptsha8"],['text'=> "$photo1" ,'url'=>"http://telegram.me/cptsha8"]
	  ],
	  [
	  ['text'=>"الروابط",'url'=>"http://telegram.me/cptsha8"],['text'=> "$link1" ,'url'=>"http://telegram.me/cptsha8"]
	  ],
	  [
	  ['text'=>"الاغاني",'url'=>"http://telegram.me/cptsha8"],['text'=> "$audio1" ,'url'=>"http://telegram.me/cptsha8"]
	  ],
	  [
	  ['text'=>"البصمات",'url'=>"http://telegram.me/cptsha8"],['text'=> "$voice1" ,'url'=>"http://telegram.me/cptsha8"]
	  ],
	  [
	  ['text'=>"الفيديو",'url'=>"http://telegram.me/cptsha8"],['text'=> "$video1" ,'url'=>"http://telegram.me/cptsha8"]
	  ],
	  [
	  ['text'=>"الملصقات",'url'=>"http://telegram.me/cptsha8"],['text'=> "$sticker1" ,'url'=>"http://telegram.me/cptsha8"]
	  ],
   [
	  ['text'=>"التوجيه",'url'=>"http://telegram.me/cptsha8"],['text'=> "$fwd1" ,'url'=>"http://telegram.me/cptsha8"]
	  ],
	  [
	  ['text'=>"المحادثة",'url'=>"http://telegram.me/cptsha8"],['text'=> "$text1" ,'url'=>"http://telegram.me/cptsha8"]
	  ],
	  [
	  ['text'=>"الالعاب",'url'=>"http://telegram.me/cptsha8"],['text'=> "$game1" ,'url'=>"http://telegram.me/cptsha8"]
	  ],
	  [
	  ['text'=>"الملفات",'url'=>"http://telegram.me/cptsha8"],['text'=> "$doc1" ,'url'=>"http://telegram.me/cptsha8"]
	  ],
	  [
	  ['text'=>"التثبيت",'url'=>"http://telegram.me/cptsha8"],['text'=> "$pin1" ,'url'=>"http://telegram.me/cptsha8"]
	  ]
   ]
   ])
   ]);
...
*Please now send new  welcome* 🌐", 
   ...
   'reply_markup'=>json_encode([
      'inline_keyboard'=>[
	  [
	  ['text'=> "تالع 💡" ,'url'=>"http://telegram.me/cptsha8"]
	  ],
	  	 [
...
Click to you want and get a order your Gp🚨",
   ...
   [
  	['text'=>"🎭 ARLOUefg«~»  المطورين 🎭",'callback_data'=>"dev"]
	  ]
   ]
   ])
   ]);
...
{
 $phone = 'شو حبيبي تريد رقم الباشا';
 $nameea = 'ARLOUefg';
bot('sendContact',[
 'chat_id'=>$chat_id,
 'phone_number'=>$phone,
...
sendaction($chat_id, typing);
   ...
   'reply_markup'=>json_encode([
      'inline_keyboard'=>[
 	 [
	  ['text'=>"تابع 🌐" ,'url'=>"http://telegram.me/cptsha8"]
	  ]
   ]
   ])
   ]);
